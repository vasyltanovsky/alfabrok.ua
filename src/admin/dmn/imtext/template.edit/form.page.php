...
function setLinkDictId() {
	...
	return;	
		      ...
		      <form action="template.data.retention.php" id='userForm' class="zpFormWinXP" method="POST">
                        ...
                        <fieldset>
                        	<legend>Данные текста</legend>
                         	<label class='zpFormLabel'>Описание</label>
                            <br /> 
                            <textarea name="it_text" cols="40" rows="10" class="zpForm"><?php echo $active_id['it_text'];?></textarea>
                            <br />
                            ...
                            <input class='zpForm' value="<?php echo $active_id['it_id'];?>" size="40" name="it_id" id="it_id"  type="hidden" >	 
