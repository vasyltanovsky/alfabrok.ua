...
checkIfLoadedFromHDD();
		      ...
		      <form action="template.data.retention.php" id='userForm' class="zpFormWinXP" method="POST">
                       ...
                       <fieldset>
                        	<label class='zpFormLabel'>ID позиции</label>
                            <input class='zpForm' value="" size="13" name="dict_id" type="text" >
                            <br />
                            <label class='zpFormLabel'>Код позиции</label>
                            <input class='zpForm' value="" size="40" name="dict_code" type="text" >
                            <br />
                            <label class='zpFormLabel'>Значение позиции</label>
                            <input class='zpFormRequired' value="" size="40" name="dict_name" type="text" >
                            <br />
							...
							<label class="zpFormLabel">Отображать (только для обл., р-н., и т.д.)</label>
							    <input value="1" checked="checked" name="hide" type="checkbox" class="zpForm"/> <br /> <br />
							
                            <input class='zpForm' value="add_position_page" size="13" name="retention" type="hidden" >
                            <br />
                        </fieldset>
