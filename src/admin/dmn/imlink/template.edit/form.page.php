                        	...
                        	<legend>Данные ссылки</legend>
                         	<label class='zpFormLabel'>Каталог недвижимости:</label>
								<select name="type_im" id="type_im" class="zpFormRequired">
									<option value="">Не выбрано</option>
									<?php echo sel_parent_standart($im_catalog_id_add, $active_id['type_im'], 'dict_id', 'dict_name');?>
								</select>
							<br /> 
							<label class='zpFormLabel'>Аренда/Продажа:</label>
								<select name="type_rs" id="type_rs" class="zpFormRequired">
									<option value="rent" <?php echo $type_rent;?>>Аренда</option>
									<option value="sale" <?php echo $type_sale;?>>Продажа</option>
								</select>
							<br />
                            <label class='zpFormLabel'>Название сслыки</label>
                            <input class='zpFormRequired' value="<?php echo $active_id['il_name'];?>" size="40" name="il_name" id="il_name" maxlength="105" type="text" >
                            <br />
                            <label class='zpFormLabel'>Заголовок ссылки</label>
                            <input class='zpFormRequired' value="<?php echo $active_id['il_title'];?>" size="40" name="il_title" id="il_title" maxlength="255" type="text" >
                            <br />
                            <!-- <label class='zpFormLabel'>Описание</label>
                            <br /> 
                            <textarea name="il_text" cols="40" rows="10" class="zpForm"><?php echo $active_id['il_text'];?></textarea>
                            <br />  -->
                            <label class='zpFormLabel'>Айди переменная</label>
                            <input class='zpFormRequired' value="<?php echo $active_id['dict_id'];?>" size="40" name="dict_id" id="dict_id"  type="text" >
                            <br />
                            <input class='zpForm' value="<?php echo $active_id['type_reg'];?>" size="40" name="type_reg" id="type_reg"  type="hidden" >	
                            <input class='zpForm' value="<?php echo $active_id['il_id'];?>" size="40" name="il_id" id="il_id"  type="hidden" >	 
