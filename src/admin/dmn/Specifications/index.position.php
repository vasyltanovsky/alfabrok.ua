...
<form  id="myForm" action="" method="post">  
    ...
    <div class="eventForm">
     	<a href="#" title="добавить значение" id="submitAdd" ><img src="../utils/images/submit/submitAdd.png" width="28" height="24" /></a>
        <a href="#" title="редактировать значение" id="submitEdit" ><img src="../utils/images/submit/submitEdit.png" width="28" height="24" /></a>
        <a href="#" title="удалить значение" id="submitDell" ><img src="../utils/images/submit/submitDell.png" width="28" height="24" /></a>
    </div>
    <!--	-->
        <div id="loading">
        </div>
