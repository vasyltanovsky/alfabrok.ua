...
DOC_ROOT . '/config/class.config.php';

  // Подключаем блок авторизации
  require_once("../utils/security_mod.php");
 
  $title = 'Управление блоком &#8220;Новости&#8221;.';
  $pageinfo = '<p class=help>Здесь можно добавлять, редактировать и удалять &#8220;Новости сайта&#8221;.</p>';
...
<form  id="myForm" action="" method="post">   
    <div class="eventForm">
    	<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="добавить новость" id="submitAdd"><span class="ui-icon ui-icon-plus"></span>добавить новость</a>
		<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="редактировать новость" id="submitEdit"><span class="ui-icon ui-icon-pencil"></span>редактировать новость</a>
		<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="удалить новость" id="submitDell"><span class="ui-icon ui-icon-trash"></span>удалить новость</a>
	 </div>
