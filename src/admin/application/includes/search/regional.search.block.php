...
<div class="regionalBlock">
	...
	<div class="reginalTree">
		<?php echo Controller::Template("/application/includes/search/regional.search.block.item.php", array("list"=> $Data->return["child"], "Data" => $Data, "margin" => 0, "parent_id" => 0, "is_checked" => false )); ?>
	</div>
