...
class language {
	...
	public $table_lang;
	// ����������� ������
	public function __construct($lang_post = NULL, $cookie_lang_code = NULL, $cookie_lang_id = NULL, $lang_code = ukr, $lang_id = NULL, $set_cookie = NULL, $table_lang = NULL) {
	...
	public function select_table($code) {
		$result = mysql_query ( "SELECT * FROM language 
						  					WHERE lang_code = '" . $code . "' " ) or die ( "Invalid query: " . mysql_error () );
