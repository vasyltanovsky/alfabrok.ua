<?php
/*
 * Класс обработчик справочников сайта 
 *
 * @version class.dictionaries.php,v 2.0 2010/05/28
 * @author <AlexTsurkin/>
 * @license GNU GPLv3
 */
class dictionaries {
	...
	public function buid_dictionaries($table, $where = NULL, $order = NULL) {
		...
		while ( $t_dictionaries [] = mysql_fetch_array ( $tbl ) ) {
			#в слове Киев удаляем первую букву
	...
	public function do_dictionaries($value_id) #айди словаря
{
		$this->my_dct = NULL;
	...
	public function have_some_id($value_id) #айди списка словаря
{
		return $this->do_dictionaries ( $this->buld_table [$value_id] [ld_id] );
	}
	
	#функция возвращает значение указаного поля с таблицы значений списка словаря и с таблицы словаря
	public function return_field_value($value_id, #айди списка словаря
$name_field, #имя поля списка словаря 
$name_field_list = NULL) #имя поля словаря
{
	...
	#функция возвращает значение указаного поля с таблицы значений списка словаря и с таблицы словаря
	public function return_field_value_and_parent($value_id, #айди списка словаря
$name_field, #имя поля списка словаря 
$name_field_paremt, #имя поля списка parent 
$name_field_list = NULL) #имя поля словаря
{
     ...
     *
     * @param  $arr - массив всех элементов справочника
     ...
     * @param  $return - сформированный древовыдный массив
