	...
	protected function getTypeAsRtfCode() {
		...
		switch ($this->_type) {
			case self::TYPE_ALL :
				...
				throw new PHPRtfLite_Exception ( 'Header/Footer type ' . $this->_type . ' is not allowed, ' . 'when using odd even different!' );
			...
			case self::TYPE_LEFT :
				...
				throw new PHPRtfLite_Exception ( 'Header/Footer type ' . $this->_type . ' is not allowed, ' . 'when using not odd even different!' );
			...
			case self::TYPE_FIRST :
				...
				throw new PHPRtfLite_Exception ( 'Header/Footer type ' . $this->_type . ' is not allowed, ' . 'when using not special layout for first page!' );
