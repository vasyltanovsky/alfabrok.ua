...
class PHPRtfLite_Border {
	 ...
	 */
	public function __construct(PHPRtfLite $rtf, PHPRtfLite_Border_Format $left = null, PHPRtfLite_Border_Format $top = null, PHPRtfLite_Border_Format $right = null, PHPRtfLite_Border_Format $bottom = null) {
		$this->_rtf = $rtf;
		if ($left) {
	 ...
	 */
	public static function create(PHPRtfLite $rtf, $size = 0, $color = null, $type = null, $space = 0, $left = true, $top = true, $right = true, $bottom = true) {
		$border = new self ( $rtf );
