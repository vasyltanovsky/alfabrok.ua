...
class immovablesModelClass extends modelClass {
	...
	public function getListPager($param, $page_id, $pagerlink) {
		...
		$propParam = array ("hide" => "show", "im_catalog_id" => $param ["im_catalog_id"] );
	...
	public function buildPropertiesData() {
		...
		$this->propertiesData->GetArrToPrint ( 'im_id', array ('is_print_list', 'is_print_ad', 'is_print_st' ) );
	}
	...
	public function getItemProperties($id) {
		$serRes = $this->provider->getPropertiesList ( array ("im_id" => $id ) );
