<div class="DivCatMenu"> 
	...
	<div class="DivCatMenuLinkImages">	
    	<a rel='nofollow' href="javascript:SetImLink('flat');" id="Flat" title="<?php echo getLangString('ImLinkFlat');?>">
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/flat.png" title="<?php echo getLangString('ImLinkFlat');?>"/>
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/flat_1.png" title="<?php echo getLangString('ImLinkFlat');?>"/>
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/flat_2.png" title="<?php echo getLangString('ImLinkFlat');?>"/>
			</a>
		<a rel='nofollow' href="javascript:SetImLink('commercial');" id="Commercial"  title="<?php echo getLangString('ImLinkCommercial');?>">
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/commercial.png"  title="<?php echo getLangString('ImLinkCommercial');?>" />
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/commercial_1.png"  title="<?php echo getLangString('ImLinkCommercial');?>" />
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/commercial_2.png"  title="<?php echo getLangString('ImLinkCommercial');?>" />
			</a>
		<a rel='nofollow' href="javascript:SetImLink('home');" id="Home"  title="<?php echo getLangString('ImLinkHome');?>">
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/home.png" title="<?php echo getLangString('ImLinkHome');?>" />
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/home_1.png" title="<?php echo getLangString('ImLinkHome');?>" />
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/home_2.png" title="<?php echo getLangString('ImLinkHome');?>" />
			</a>
		<a rel='nofollow' href="javascript:SetImLink('buildings');" id="Buildings"  title="<?php echo getLangString('ImLinkBuildings');?>">
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/buildings.png" title="<?php echo getLangString('ImLinkBuildings');?>"/>
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/buildings_1.png" title="<?php echo getLangString('ImLinkBuildings');?>"/>
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/buildings_2.png" title="<?php echo getLangString('ImLinkBuildings');?>"/>
			</a>
		<a rel='nofollow' href="javascript:SetImLink('land');" id="Land"  title="<?php echo getLangString('ImLinkLand');?>">
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/land.png" title="<?php echo getLangString('ImLinkLand');?>" />
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/land_1.png" title="<?php echo getLangString('ImLinkLand');?>" />
			<img src="<?php echo getLangString("imageDomain")?>/files/images/bg/cat/land_2.png" title="<?php echo getLangString('ImLinkLand');?>" />
			</a>
		<div class="clear"></div>	
	</div>		
