...
<table cellpadding="0" cellspacing="0" border="0" class="list_Flat_table_block">
	...
	<?php foreach ($Model->list as $key => $value):?>
        <tr>
            ...
            <td class="ListTableImIndexImg"><a href="/ru/<?php echo $routingObj->getController();?>/<?php echo $routingObj->getAction();?>/<?php echo $routingObj->getParamItem("page_id", 1);?>/<?php echo $value["im_id"]; ?>"><img src="<?php echo getLangString('imageDomain');?>/files/images/immovables/st_#im_photo#" alt="<?php echo $value["im_title"];?>"/></a></td>
