...
<table cellpadding="0" cellspacing="0" border="0" class="list_Flat_table_block">
    ...
    <tr>
    	...
    	<td class="TdListRightBorder"><a href="/ru/home/sale/<?php echo $routingObj->getParamItem("page_id", 1);?>/<?php echo $value["im_id"]; ?>#YMapsID"><?php echo appHtmlClass::partial("immovables/ymap/image", array("Model"=>$Model, "item" => $value, "m" => $m) );?></a></td>	
	</tr>
	<?php endforeach;?>
</table>