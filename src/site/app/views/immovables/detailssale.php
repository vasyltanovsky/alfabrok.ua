	...
	<table cellpadding="0" cellspacing="0" border="0" class="TableOneImmovableHeder">
		<tr>
			...
			<td class="TOIItdFunctional">
				<a id="" href="/ru/report/word/<?php echo $Model->item["im_id"];?>" target="_blank"  alt="<?php echo getLangString("SubmitImWord");?>" title="<?php echo getLangString("SubmitImWord");?>"><img src="<?php echo getLangString("imageDomain");?>/files/images/submit/submitWord.png" alt="<?php echo getLangString("SubmitImWord");?>" title="<?php echo getLangString("SubmitImWord");?>"/></a><br/>                           
				<a id="TOIItdFunctional" target="_blank" href="/ru/report/pdf/<?php echo $Model->item["im_id"];?>" alt="<?php echo getLangString("SubmitPdf");?>" target="_blank" title="<?php echo getLangString("SubmitPdf");?>"><img src="<?php echo getLangString("imageDomain");?>/files/images/submit/submitPdf.png" alt="<?php echo getLangString("SubmitImPrint");?>" title="<?php echo getLangString("SubmitPdf");?>"/></a><br/>
...
<!-- similar -->
<?php
$paramSimilar = array("is_cashe" => true, "im_is_sale" => true, "im_catalog_id" => $Model->item["im_catalog_id"], "im_id" => $Model->item["im_id"], "im_area_id" => $Model->item["im_area_id"], "im_adress_id" => $Model->item["im_adress_id"], "im_space_like" => $Model->item["im_space"], "im_prace_like" => $Model->item["im_prace"], "limit" => 10);
