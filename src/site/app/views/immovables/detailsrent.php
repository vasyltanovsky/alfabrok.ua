	...
	<table cellpadding="0" cellspacing="0" border="0" class="TableOneImmovableHeder">
		<tr>
			...
			<td class="TOIItdIminfo">
				...
				<?php echo appHtmlClass::partial("immovables/details/pricemanth", array("Data" => $Model->item, "key" => "im_prace_manth"));?>
				<?php echo appHtmlClass::partial("immovables/details/priceother", array("Data" => $Model->item, "key" => "im_prace"));?>
			</td>
...
<?php
$paramSimilar = array("is_cashe" => true, "im_is_rent" => true, "hide" => "show", "im_catalog_id" => $Model->item["im_catalog_id"], "im_id" => $Model->item["im_id"], "im_area_id" => $Model->item["im_area_id"], "im_adress_id" => $Model->item["im_adress_id"], "im_space_like" => $Model->item["im_space"], "im_prace_manth_like" => $Model->item["im_prace_manth"], "limit" => 10);
