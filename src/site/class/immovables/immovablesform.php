...
class ImSiteForm {
    ...
    */
	public function PostGetParser($Arr) {
		...
		$ImQuery = "";
		$ArrNoDo = array ('exchange_rate', 'SearchImCode', 'action', '1', 'type_cat', 'SearchIsAdvasedChecked', "page_id", "page", "hide", "im_catalog_id", "im_is_rent", "im_is_sale", "is_prop_sale", "is_prop_rent", "exchange_rate" );
