...
<?php if($Model->list):?>
	<div class="SearchImmovablesCodes">
		<?php foreach ($Model->list as $key => $value):?>
			<span><?php echo $value["im_code"];?><a href="/ru/immovables/search?id=<?php echo str_replace($value["im_code"], "", strtoupper($routingObj->getParamItem("id")));?>&action=s_code">X</a></span>
		<?php endforeach;?>
	</div>
