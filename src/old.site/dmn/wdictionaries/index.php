...
<form  id="myForm" action="" method="post">   
    <div class="eventForm">
     	<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="добавить справочник" id="submitAdd"><span class="ui-icon ui-icon-plus"></span>добавить справочник</a>
		<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="редактировать справочник" id="submitEdit"><span class="ui-icon ui-icon-pencil"></span>редактировать справочник</a>
		<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="удалить справочник" id="submitDell"><span class="ui-icon ui-icon-trash"></span>удалить справочник</a>
	 </div>
