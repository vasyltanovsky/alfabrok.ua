...
require_once DOC_ROOT . '/config/class.config.php';
  ...
  $title = 'Управление услугами организации';
 $pageinfo = '<p class=help>Здесь можно добавлять, редактировать и удалять &#8220;Услуги организации&#8221;.</p>';
...
<form  id="myForm" action="" method="post">   
	 <div class="eventForm">
    	<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="добавить услугу" id="submitAdd"><span class="ui-icon ui-icon-plus"></span>добавить услугу</a>
		<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="редактировать услугу" id="submitEdit"><span class="ui-icon ui-icon-pencil"></span>редактировать услугу</a>
		<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="удалить услугу" id="submitDell"><span class="ui-icon ui-icon-trash"></span>удалить услугу</a>
	 </div>
