...
require_once DOC_ROOT . '/config/class.config.php';
  ...
  $title = 'Управление боком &#8220;Ссылки недвижимости&#8221;';
 $pageinfo = '<p class=help>Здесь можно добавлять, редактировать и удалять &#8220;Ссылки недвижимости&#8221;.</p>';
...
<form  id="myForm" action="" method="post">   
    <div class="eventForm">
    	<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="добавить ссылку" id="submitAdd"><span class="ui-icon ui-icon-plus"></span>добавить ссылку</a>
		<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="редактировать ссылку" id="submitEdit"><span class="ui-icon ui-icon-pencil"></span>редактировать ссылку</a>
		<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="удалить ссылку" id="submitDell"><span class="ui-icon ui-icon-trash"></span>удалить ссылку</a>
	 </div>
