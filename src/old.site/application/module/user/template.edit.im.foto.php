	...
	function mycallbackformPhoto(v,m,f){
		if(v == 'dell')
		{
			var optionsDellPhotoOk = { 
				...
				url:'/application/module/user/template.dell.item.img.php'
			};
			$('#FormListImg').ajaxSubmit(optionsDellPhotoOk); 
			return true;
		} else return false;
		...
		<tr>
			...
			<div>
				    ...
				    <div class="eventForm">
				       	...
				       	<a href="#" class="UAddSome" id="submitDellPhoto" style="-moz-border-radius: 4px 4px 4px 4px;"><span class="ui-icon ui-icon-trash"></span><?php echo $arWords['im_add_im_btm_dell_img'];?></a>
				    </div>
