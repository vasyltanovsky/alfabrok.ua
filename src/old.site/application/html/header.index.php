...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <link href="/css/dialog.windows.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="/js/geocoderImList.js"></script>
    <script type="text/javascript" src="/js/YMapsSearch.js"></script>
	<script src="/js/index.page.js" type="text/javascript"></script>	
    ...
    <!--[if lt IE 7]><![if gte IE 5.5]><script type="text/javascript" src="/js/fixpng.js"></script><![endif]><![endif]-->
</head>
<body>
